...
grub_target_cc_version='x86_64-pc-linux-gnu-gcc (Gentoo 5.4.0-r3 p1.3, pie-0.6.5) 5.4.0'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-pc-linux-gnu/5.4.0/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_package="grub"
grub_package_string="GRUB 2.02~rc1"
grub_package_version="2.02~rc1"
